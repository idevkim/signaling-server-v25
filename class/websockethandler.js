...
exports.onCandidate = exports.onAnswer = exports.onOffer = exports.onDisconnect = exports.onConnect = exports.onReqAvatarList = exports.remove = exports.add = exports.reset = void 0;
...
function reset(mode) {
    ...
    // isPrivate = mode == 'private';//"private";
...
//idevkim
function onReqAvatarList(ws) {
    var avatarList = [];
    // console.log(`clients size => ${clients.size}`);
    clients.forEach(function (_v, k) {
        var parts = k.protocol.split('_'); //protocols = "avatar_"+connectionId+"_comp001";
        if (parts[0] === "avatar") {
            avatarList.push(parts[1]);
        }
        // console.log(`k.protocol.split('_') : ${parts[0]},${parts[1]},${parts[2]}`);
    });
    ws.send(JSON.stringify({ type: "gotAvatarList", avatarList: avatarList.sort() }));
}
exports.onReqAvatarList = onReqAvatarList;

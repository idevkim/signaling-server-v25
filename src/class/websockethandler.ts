...
function onReqAvatarList(ws: WebSocket): void {
  ...
  clients.forEach((_v, k) => {
    let parts:string[] = k.protocol.split('_');//protocols = "avatar_"+connectionId+"_comp001";
    if(parts[0] === "avatar") {
...
export { reset, add, remove, onReqAvatarList, onConnect, onDisconnect, onOffer, onAnswer, onCandidate };
